...
public class ClientController {
	...
	@GetMapping("empreg")
	public ModelAndView empregistraion() {
	...
	@PostMapping("checkadminlogin")
	  public ModelAndView checkadminlogin(HttpServletRequest request)
	  {
	    ...
	    long empcount = adminService.empcount();
	   ...
	   @GetMapping("addcustomer")
	     ...
	     public String  addcustomer(Model m)
	     {
		   ...
		   List<Customer> customerlist = adminService.viewallcustomer();
		    m.addAttribute("customerdata", customerlist);
...
//		}
	   ...
	   @GetMapping("setstatus")
		public ModelAndView setstatus(@RequestParam("id") int id ,@RequestParam("status") boolean status) {
		   int n = adminService.updatestatus(id, status);
